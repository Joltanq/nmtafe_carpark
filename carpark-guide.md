...
| `Sensor`     | id, is_active, car_park                      | update_car_park, detect_vehicle, scan_plate   |
| `Display`    | id, message, is_on, car_park                 | update                                        |
...
![screenshot_of_tags.jpg](images/screenshot_of_tags.jpg)
...
> It should be tested in CarPark unit tests, as register is a method within the CarPark class
